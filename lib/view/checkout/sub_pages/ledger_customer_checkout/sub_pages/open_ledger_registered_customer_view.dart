...
import 'package:groc_pos_app/view_model/checkout/ledger_customer_checkout/open_ledger_registered_customer_view_model.dart';
import 'package:uuid/uuid.dart';

import '../../../../../resources/fonts/app_fonts_names.dart';
import '../../../../manage_expenses/edit_shop_expense.dart';

class OpenLedgerRegisteredCustomerView extends StatefulWidget {
  OpenLedgerRegisteredCustomerView({super.key, required this.data});
  dynamic data;

  @override
  State<OpenLedgerRegisteredCustomerView> createState() =>
      _OpenLedgerRegisteredCustomerViewState();
}

class _OpenLedgerRegisteredCustomerViewState
    extends State<OpenLedgerRegisteredCustomerView> {
  ...
  _loadAllLedgerCustomerPurchases() {
    ...
    _ledgerCustomerPurchasesCollectionReferenceStream =
        OpenLedgerRegisteredCustomerViewModel().fetchAllCustomerPurchases(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: CustomAppColors.mainThemeColorBlueLogo,
        heroTag: const Uuid().v4().toString(),
        onPressed: () {
          Get.toNamed(RouteName.addNewPurchaseInTheLedgerOfCustomer,
              arguments: {
