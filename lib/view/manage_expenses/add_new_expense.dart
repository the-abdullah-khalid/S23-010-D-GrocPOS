...
import 'package:groc_pos_app/view_model/manage_expenses/add_expense_view_model.dart';
...
class _AddNewExpenseState extends State<AddNewExpense> {
  ...
  _performAddNewExpense() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      bool status =
          await AddExpenseViewModel().addNewExpense(context, expenseDetails);
            ...
            child: Column(
              ...
              children: [
                ...
                RoundButton(
                  ...
                  title: 'Add Expense To System',
                  onTap: _performAddNewExpense,
                ),
              ],
            ),
          ),
