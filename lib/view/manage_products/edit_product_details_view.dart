...
import 'package:groc_pos_app/view_model/manage_products/edit_products_view_model.dart';
...
class EditProductDetailScreen extends StatefulWidget {
  dynamic data;
  EditProductDetailScreen({super.key, required this.data});

  @override
  State<EditProductDetailScreen> createState() => _EditNewProductScreenState();
}

class _EditNewProductScreenState extends State<EditProductDetailScreen> {
  String previousProductId = 'a';
  ...
  _loadShopModel() {
    ...
    //setting the text controllers
    productNameController.text = productModel!.productName;
    dropdownCategoryValue = productModel!.productCategory;
    productBrandController.text = productModel!.productBrand;
    productManufactureController.text = productModel!.productManufactureName;
    stockController.text = productModel!.productStock.toString();
    dropdownUnitValue = productModel!.productUnit;
    purchasePriceController.text =
        productModel!.productPurchasePrice.toString();
    mrpRetailPriceController.text = productModel!.productMrp.toString();
    barCodeController.text = productModel!.productBarcode.toString();

    productExpiryDate =
        DateFormat("MM/dd/yyyy").parse(productModel!.productExpiryDate);

    //->old previous product id
    previousProductId = productModel!.productId;
  }
  ...
  _performEditProduct() async {
    ...
    if (_formKey.currentState!.validate()) {
      final productDetails = {
        ...
        'old_productID': previousProductId,
      };
      // debugPrint(productDetails.toString());
      bool status = await EditProductViewModel()
          .editProductDetails(productDetails, context);

      // Map<String, dynamic> editedProductDetailsDocument = {...productDetails};
      // print(editedProductDetailsDocument.remove('old_productID'));
      // print(editedProductDetailsDocument);
          ...
          child: Column(
            ...
            children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        barCodeController.text =
                            barCodeController.text.replaceAll(RegExp('-'), '');
                      },
                      child: const Padding(
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () {
                        if (barCodeController.text.isEmpty) {
                          ...
                          // Navigator.pushNamed(
                          //   context,
                          //   RouteName.customQRCodeGenerationScreen,
                          //   arguments: {
                          //     'product_name':
              ...
              RoundButton(
                ...
                title: 'Edit Product To System',
                onTap: _performEditProduct,
              ),
              const SizedBox(
                height: 20,
              )
