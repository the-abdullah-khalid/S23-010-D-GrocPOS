...
class UploadEasyPisaDetailsView extends StatefulWidget {
  const UploadEasyPisaDetailsView({super.key});

  @override
  State<UploadEasyPisaDetailsView> createState() =>
      _UploadEasyPisaDetailsViewState();
}

class _UploadEasyPisaDetailsViewState extends State<UploadEasyPisaDetailsView> {
  ...
  _uploadImageToDatabase() async {
    ...
    dynamic paymentDetails = {
      ...
      DatabasePaymentCollectionName.PAYMENTMETHOD: "easy-paisa"
    };
    bool status = await EasyPisaPaymentDetailsViewModel()
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Easy Pisa Account Number',
                ...
                child: _image != null
                    ? Column(
                        children: [
                          ...
                          Text(
                              "Easy Pisa QR Code for Account Number ${accountNumberDetails.text.trim()}")
                        ],
                      )
                    : const Column(
                        children: [
